...
public class c4_LifecycleHooks extends LifecycleHooksBase {
    ...
    public void terminator() {
        ...
        // This flux is not counted because it is cancelled before it terminates
        StepVerifier.create(temperatureFlux.take(0))
                    .expectNextCount(0)
                    .verifyComplete();

        // This flux is counted because it terminates
        StepVerifier.create(temperatureFlux.skip(20))
                    .expectNextCount(0)
                    .verifyComplete();

        // This flux is counted because it terminates with an error
    ...
    public void one_to_rule_them_all() {
        ...
        Flux<Integer> flux = Flux.just(19, 26, 34)
